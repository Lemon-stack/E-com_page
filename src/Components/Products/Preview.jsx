    ...
    <>
      {isLoading && (
        <div role="status" class="flex justify-center items-center">
          <svg
            aria-hidden="true"
            class="w-16 h-16 mx-auto my-60 text-gray-200 animate-spin dark:text-gray-200 fill-blue-500"
            viewBox="0 0 100 101"
            fill="none"
      ...
      <p class="font-bold text-blue-500 text-xl">There seems to be an error</p>
      <span>Try refereshing or go back to the previous page</span>
      </div>}
        ...
        <div class="flex flex-col items-start bg-gray-50 p-2 m-2 relative rounded-lg shadow-lg md:flex-row">
          ...
          <div class="flex flex-row items-center justify-between mx-2 md:flex-row md:absolute md:right-0 md:bottom-5">
            ...
            >
              Enquire
              <svg
                class="w-[20px] h-[20px] ml-1 text-gray-50 dark:text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
