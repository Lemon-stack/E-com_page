...
export default function Header(){
	const whatsAppClick = () => {
    // Replace 'your-phonenumber' with your actual phone number including the country code
    const phoneNumber = '+234 705 407 4103';
...
<NavLink to="/" className={({isActive})=>isActive?'font-bold':"font-normal"
  ...
  <li onClick={whatsAppClick} class="mr-7 hover:font-bold">Contact</li>
</div>
    </div>
		)
}